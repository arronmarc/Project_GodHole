...
function config_timeCycle() {
	...
	//-------------------------------
	cycleLength = 10;      //Length of a entire day/night cycle in REAL WORLD MINUTES.
	...
	ds_list_replace(months,1,"January");
	ds_list_replace(months,2,"February");
	ds_list_replace(months,3,"March");
	ds_list_replace(months,4,"April");
	...
	ds_list_replace(seasons,2,"Spring");
	ds_list_replace(seasons,3,"Spring");
	ds_list_replace(seasons,4,"Summer");

...
//global.__ppf_debug_ui_external
...
function __PPFX_DebugInspectorGenerator() constructor {
	...
	static __PPFX_System = function() {
		...
		// from system
			...
			// Profile
			.AddElement(new __ppf_ui_folder("Profile", false, 13))
				...
				.AddElement(new __ppf_ui_folder("Effects Loaded", false, 3))
					.AddElement(new __ppf_ui_text_ext("", 0, function(element) {
					...
					.AddElement(new __ppf_ui_method("Effects Array", 0,
						...
						function(element) {
							...
							//		// move if enough drag
							//		if (abs(_drag_y_diff) > _text_height) {
							//			if (_drag_y_diff > 0) {
							//				if (selected_item < isize-1) {
							//					// up
							//					selected_item_struct.SetOrder(_array[selected_item+1].GetOrder()+1);
			...
			.AddElement(new __ppf_ui_folder("Stack", false, 5))
				...
				.AddElement(new __ppf_ui_method("Surfaces", 0,
					function() {
						...
						preview_stack_surface_height = 0;
		...
		.AddElement(new __ppf_ui_menu("SUNSHAFTS (GODRAYS)", false, 16)) // 15
			...
			.AddElement(new __ppf_ui_slider("Dimmer", 0, false, gui_ef_get_param_simple(FX_EFFECT.SUNSHAFTS, PP_SUNSHAFTS_DIMMER), 0, 2, true, function(output) {gui_ef_set_param_simple(output, FX_EFFECT.SUNSHAFTS, PP_SUNSHAFTS_DIMMER);}))
